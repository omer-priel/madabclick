...
const CardAboutUs: React.FC<CardProps> = ({ littleTitle, title, description, imageSrc }) => {
  return (
    <div className='flex flex-col h-[45vh] w-[55vh] items-stretch max-md:ml-0  mx-auto relative'>
      <div
        className='shadow-sm bg-cyan-500 bg-opacity-20 flex grow flex-col justify-center items-center w-full
      rounded-3xl border-2 border-solid border-teal-400 max-md:max-w-full max-md:px-5'
      >
        ...
        <Image
          ...
          className='aspect-[0.97] object-contain object-center w-[115px] h-[119px] overflow-hidden shrink-0 max-w-full
          justify-self: end'
          width={115}
          height={119}
        />
