...
const CardAboutUs: React.FC<CardProps> = ({ littleTitle, title, description, imageSrc }) => {
  return (
    <div className='flex flex-col items-stretch w-[77%] max-md:w-full max-md:ml-0 relative'>
      <div
        className='shadow-sm bg-cyan-500 bg-opacity-20 flex grow flex-col justify-center items-center
      w-full px-16 py-12 rounded-3xl border-2 border-solid border-teal-400 max-md:max-w-full max-md:px-5'
      >
